...
export function FilterBar({
  ...
  const programTypeOptions = useMemo<Option[]>(() => {
    return [
      { value: 'false', label: t('dashboard.creditHours') },
      { value: 'true', label: t('dashboard.parallelEducation') },
    ];
  }, [t]);
